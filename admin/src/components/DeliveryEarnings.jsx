    ...
    <div className="card p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex space-x-2">
          <button 
            className={`px-3 py-1 rounded-md ${viewMode === 'total' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
            onClick={() => setViewMode('total')}
          >
            All Time
          </button>
          <button 
            className={`px-3 py-1 rounded-md ${viewMode === 'monthly' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
